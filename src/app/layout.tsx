...
// import { Logo } from '@/components/branding/Logo'; // Commented out - unused
        ...
        <ThemeProvider>
          ...
          <footer style={{ 
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'center', gap: '32px' }}>
              <Link href="/terms" style={{ color: '#9ca3af', textDecoration: 'none', transition: 'color 0.15s' }}
                onMouseEnter={e => e.currentTarget.style.color = '#f97316'}
                onMouseLeave={e => e.currentTarget.style.color = '#9ca3af'}>
                Terms
              </Link>
              <Link href="/privacy" style={{ color: '#9ca3af', textDecoration: 'none', transition: 'color 0.15s' }}
                onMouseEnter={e => e.currentTarget.style.color = '#f97316'}
                onMouseLeave={e => e.currentTarget.style.color = '#9ca3af'}>
                Privacy
              </Link>
